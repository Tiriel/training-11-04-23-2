 ...
 */
final class Version20220525093628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, birthday DATE DEFAULT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL)');
